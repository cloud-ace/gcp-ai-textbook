...
def pipeline(
        ...
        checkpoint_path="gs://shoseki-ai-platform/custom_model_new/train/object_detection_train/model_dir/model.ckpt-2000",
        config_path="gs://shoseki-ai-platform/custom_model_new/train/object_detection_train/ssd_mobilenet_v2_oid_v4_2018_12_12/pipeline_new.config",
        model_export_path="gs://shoseki-ai-platform/custom_model_new/train/object_detection_train/model_dir/export/Servo/1587553106",
