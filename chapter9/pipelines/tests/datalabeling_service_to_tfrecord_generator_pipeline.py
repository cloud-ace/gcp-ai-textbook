...
def pipeline(
        ...
        dataflow_job_directory="gs://shoseki-ai-platform",
        datalabeling_service_annotation_file_path="gs://shoseki-ai-platform/data-labeling-service/export/oid_image_lebel_basketball_labeled.json",
        ...
        tfrecord_output_dir="gs://shoseki-ai-platform/tfrecord-test/image"
):
