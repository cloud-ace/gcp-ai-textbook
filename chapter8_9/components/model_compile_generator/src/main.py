...
class ModelCompileGenerator:
    ...
    def __init__(self, args):
        ...
        parser = argparse.ArgumentParser(
            description="launch edge model compile")

        parser.add_argument("--project_id", type=str, default="${your-gcp-project}", help='GCP project id')
        parser.add_argument("--trained_checkpoint_prefix", type=str,
                            default="gs://${your-gcs-bucket}/custom_model_new/train/object_detection_train/model_dir/model.ckpt"
                                    "-10002",
                            help='AI Platform trained model checkpoint file path prefix (GCS). ')
        parser.add_argument("--pipeline_config_path", type=str,
                            default="gs://${your-gcs-bucket}/custom_model_new/train/object_detection_train"
        ...
        parser.add_argument("--model_export_dir", type=str,
                            default="gs://${your-gcs-bucket}/custom_model_new/train/object_detection_train/model_dir/export",
