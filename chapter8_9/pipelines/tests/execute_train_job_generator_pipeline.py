...
def pipeline(
        ...
        ai_platform_job_directory="gs://${your-gcs-bucket}",
        number_of_classes=2,
        label_map_path="gs://${your-gcs-bucket}/tfrecord/image/20200411152510/train/label_map.pbtxt",
        tfrecord_input_path_for_train="gs://${your-gcs-bucket}/tfrecord/image/20200411152510/validation/data-00000-of-00001.tfrecord",
        tfrecord_input_path_for_eval="gs://${your-gcs-bucket}/tfrecord/image/20200411152510/validation/data-00000-of-00001.tfrecord",
        batch_size=12,
        training_steps=100,
